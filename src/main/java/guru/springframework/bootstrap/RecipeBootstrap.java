...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        recipes.add(GuacamoleRecipe(eachUom, tableSpoonUom, teaSpoonUom, dashUom, americanCategory, mexicanCategory));
        recipes.add(TacosRecipe(eachUom, tableSpoonUom, teaSpoonUom, dashUom, cupUom, pintUom, americanCategory, mexicanCategory));
     ...
     */
    private Recipe GuacamoleRecipe(UnitOfMeasure eachUom, UnitOfMeasure tableSpoonUom, UnitOfMeasure teaSpoonUom,
        ...
        guacamoleRecipe.getIngredients().add(new Ingredient("ripe avocados", new BigDecimal(2),
                                                            eachUom, guacamoleRecipe));
        guacamoleRecipe.getIngredients().add(new Ingredient("Kosher salt", new BigDecimal(".5"),
                teaSpoonUom, guacamoleRecipe));
        ...
        guacamoleRecipe.getIngredients().add(new Ingredient("minced red onion ot thinly sliced green onion",
        ...
        guacamoleRecipe.getIngredients().add(new Ingredient("Cilantro", new BigDecimal(2),
                tableSpoonUom, guacamoleRecipe));
        guacamoleRecipe.getIngredients().add(new Ingredient("freshly grated black pepper", new BigDecimal(2),
                dashUom, guacamoleRecipe));
        guacamoleRecipe.getIngredients().add(new Ingredient("ripe tomato, seeds and pupl removed, chopped",
     ...
     * @param mexicanCategory
     */
    private Recipe TacosRecipe(UnitOfMeasure eachUom, UnitOfMeasure tableSpoonUom, UnitOfMeasure teaSpoonUom, UnitOfMeasure dashUom,
                               UnitOfMeasure cupUom, UnitOfMeasure pintUom, Category americanCategory, Category mexicanCategory) {
